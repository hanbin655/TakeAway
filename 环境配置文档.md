...
选择Select All单机下一步，注意这里包含了Google的App Engine Java SDK。 如果想单独下载可以选取SDKs选项，然后在[谷歌官网下载](https://developers.google.com/appengine/downloads)。点击下一步，后面的你都懂的，看看电影让他下载吧。
